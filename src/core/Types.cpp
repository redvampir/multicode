...
auto to_string(NodeType type) -> std::string_view {
    switch (type) {
        ...
        case NodeType::PureFunction: return "PureFunction";
        ...
        case NodeType::DoWhileLoop: return "DoWhileLoop";
        case NodeType::RangeFor: return "RangeFor";
        ...
        case NodeType::NotEqual: return "NotEqual";
        case NodeType::Less: return "Less";
        case NodeType::LessEqual: return "LessEqual";
        case NodeType::Greater: return "Greater";
        case NodeType::GreaterEqual: return "GreaterEqual";
        ...
        case NodeType::BitwiseXor: return "BitwiseXor";
        case NodeType::BitwiseNot: return "BitwiseNot";
        case NodeType::ShiftLeft: return "ShiftLeft";
        case NodeType::ShiftRight: return "ShiftRight";
        ...
        case NodeType::FileRead: return "FileRead";
        case NodeType::FileWrite: return "FileWrite";
        
        // Low-Level
        case NodeType::PointerDereference: return "PointerDereference";
        case NodeType::AddressOf: return "AddressOf";
        case NodeType::MemoryCopy: return "MemoryCopy";
        case NodeType::MemoryAlloc: return "MemoryAlloc";
        case NodeType::MemoryFree: return "MemoryFree";
        ...
        case NodeType::EventHandler: return "EventHandler";
        
        // Comments & Debug
        case NodeType::Comment: return "Comment";
        case NodeType::DebugPrint: return "DebugPrint";
        case NodeType::Breakpoint: return "Breakpoint";
...
auto to_string(DataType type) -> std::string_view {
    switch (type) {
        ...
        case DataType::StringView: return "std::string_view";
        
        // Pointers
        case DataType::Pointer: return "T*";
        case DataType::Reference: return "T&";
        
        // Containers
        case DataType::Array: return "std::array<T>";
        case DataType::Vector: return "std::vector<T>";
        case DataType::Map: return "std::map<K,V>";
        case DataType::Set: return "std::set<T>";
        ...
        case DataType::Template: return "template<T>";
        case DataType::Execution: return "exec";
